...
这样做可使代码文档化，以便能帮助人们更好理解你的代码。同样，当你不小心给一个变量赋值错误的类型时，这样的写法能让编译器帮助你捕抓到错误。
...
Option包含了一些有用的方法使之得能够轻松的和可选值配合使用，比如`getOrElse`方法就允许在Option是None的时候，用一个可选值来代替:
